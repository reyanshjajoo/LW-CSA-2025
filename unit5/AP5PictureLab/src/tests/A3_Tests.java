...
public class A3_Tests {
    ...
    private static Stream<Arguments> a3Provider(){
        return Stream.of(
            Arguments.of(
                ...
                "0",  // TODO: Replace with your answer containing a number as a string (i.e. "32")
    ...
    public void e1Test() {
        ...
        Picture pix = new Picture("images/arch.jpg");
        pix.explore();
    }
