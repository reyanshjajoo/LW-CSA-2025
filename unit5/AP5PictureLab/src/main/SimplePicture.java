...
public class SimplePicture implements DigitalPicture {
    ...
    public void explore(boolean synchronous) {
        // create a copy of the current picture and explore it
        SimplePicture clone = new SimplePicture(this);
        PictureExplorer explorer = new PictureExplorer(clone);
        if (synchronous) {
            explorer.await();
        }
    }
    ...
    public void loadOrFail(String fileName) throws IOException {
        ...
        // Handle classpath resources starting with /
        try {
            java.net.URL resourceUrl = SimplePicture.class.getResource(fileName);
            if (resourceUrl != null) {
