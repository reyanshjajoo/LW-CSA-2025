...
public class Picture extends SimplePicture {
     ...
     */
    public void negate() {
        throw new RuntimeException("Replace with your code for Activity 5, Exercise 4.");
    }
    ...
    public void grayscale() {
        throw new RuntimeException("Replace with your code for Activity 5, Exercise 5.");
    }
    ...
    public void fixUnderwater() {
        throw new RuntimeException("Replace with your code for Activity 5, Exercise 6.");
    }
    ...
    public void mirrorVerticalRightToLeft() {
        throw new RuntimeException("Replace with your code for Activity 6, Exercise 1.");
    }
    ...
    public void mirrorHorizontal() {
        throw new RuntimeException("Replace with your code for Activity 6, Exercise 2.");
    }
    ...
    public void mirrorHorizontalBotToTop() {
        throw new RuntimeException("Replace with your code for Activity 6, Exercise 3.");
    }

    /**
     * TODO: Activity 6, Exercise 4.
     * Method that mirrors the picture around the top-left to bottom-right diagonal line,
     * mirroring the lower-triangle pixels into upper-triangle
     */
    public void mirrorDiagonal() {
        throw new RuntimeException("Replace with your code for Activity 6, Exercise 4.");
    }
    ...
    public void mirrorArms() {
        throw new RuntimeException("Replace with your code for Activity 7, Exercise 2.");
    }
    ...
    public void mirrorGull() {
        throw new RuntimeException("Replace with your code for Activity 7, Exercise 3.");
    }
     ...
     * Copy from the fromPic an area of pixels given by their start/end row and column
     * into this picture, in the area of same size, given by its start row and column.
     * @param fromPic     the picture to copy from
