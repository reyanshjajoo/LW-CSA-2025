...
/**
 * A program to carry on conversations with a human user. This version:<br>
...
public class Magpie3 {
    ...
    public String getResponse(String statement) {
        ...
        } else if (findKeyword(statement, "Stave") >= 0) {
            response = "He sounds like a nice teacher!";
        } else if (findKeyword(statement, "feel") >= 0 || findKeyword(statement, "bored") >= 0) {
            response = "I hear you and I feel the same.";
        } else if (findKeyword(statement, "dumb") >= 0) {
            response = "There's no reason to say this.";
        } else if (findKeyword(statement, "music") >= 0) {
            response = "What kind of music do you like?";
        } else if (findKeyword(statement, "school") >= 00) {
    ...
    /**
     * Search for one word in phrase. The search is not case sensitive. This method will check
     * that the given goal is not a substring of a longer string (so, for example, "I know" 
     * does not contain "no").
